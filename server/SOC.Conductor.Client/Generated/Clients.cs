...
public partial interface ITriggersService
{
	...
	/// <returns>Success</returns>
	/// <exception cref="ApiException">A server side error occurred.</exception>
	System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CommonTriggerDto>> GetAllTriggersAsync(System.Threading.CancellationToken cancellationToken);
